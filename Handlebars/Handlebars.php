...
use GX2CMS\TemplateEngine\Handlebars\Loader\StringLoader;
use GX2CMS\TemplateEngine\Handlebars\Cache\Dummy;
...
class Handlebars
{
     ...
     */
    private $_templateClass = 'GX2CMS\TemplateEngine\Handlebars\\Template';
    ...
    {
        if (!is_a($class, 'GX2CMS\TemplateEngine\Handlebars\\Template', true)) {
            throw new \InvalidArgumentException(
                sprintf(
