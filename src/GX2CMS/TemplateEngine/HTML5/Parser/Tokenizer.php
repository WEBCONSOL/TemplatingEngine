<?php
namespace GX2CMS\TemplateEngine\HTML5\Parser;
...
class Tokenizer
{
     ...
     *
     * @param \GX2CMS\TemplateEngine\HTML5\Parser\Scanner $scanner
     *            A scanner initialized with an input stream.
     * @param \GX2CMS\TemplateEngine\HTML5\Parser\EventHandler $eventHandler
