 ...
 */
namespace GX2CMS\TemplateEngine\HTML5\Serializer;
 ...
 * key of rules.
 *
 * For an example implementation see \GX2CMS\TemplateEngine\HTML5\Serializer\OutputRules.
 */
interface RulesInterface
{
     ...
     *
     * @param \GX2CMS\TemplateEngine\HTML5\Serializer\Traverser $traverser
     *            The traverser used in the rules.
     * @return \GX2CMS\TemplateEngine\HTML5\Serializer\RulesInterface $this for the current object.
     */
    public function setTraverser(\GX2CMS\TemplateEngine\HTML5\Serializer\Traverser $traverser);
     ...
     *
     * To learn about processor instructions see \GX2CMS\TemplateEngine\HTML5\InstructionProcessor
     *
     * Instead of returning the result write it to the output stream ($output)
     * that was passed into the constructor.
     *
