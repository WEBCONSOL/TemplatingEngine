...
use GX2CMS\TemplateEngine\HTML5\Parser\FileInputStream;
use GX2CMS\TemplateEngine\HTML5\Parser\StringInputStream;
use GX2CMS\TemplateEngine\HTML5\Parser\DOMTreeBuilder;
use GX2CMS\TemplateEngine\HTML5\Parser\Scanner;
use GX2CMS\TemplateEngine\HTML5\Parser\Tokenizer;
use GX2CMS\TemplateEngine\HTML5\Serializer\OutputRules;
use GX2CMS\TemplateEngine\HTML5\Serializer\Traverser;
...
class HTML5
{
     ...
     */
    public function parse(\GX2CMS\TemplateEngine\HTML5\Parser\InputStream $input, array $options = array())
    {
        $this->errors = array();
     ...
     * of a string, file, or resource.
     */
    public function parseFragment(\GX2CMS\TemplateEngine\HTML5\Parser\InputStream $input, array $options = array())
    {
        $options = array_merge($this->getOptions(), $options);
